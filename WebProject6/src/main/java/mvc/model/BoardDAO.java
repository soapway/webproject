...
public class BoardDAO {
	...
	public ArrayList<BoardDTO> getBoardList(int page, int limit, String items, String text) {
		...
		try {
			...
			while (rs.next()) {
				...
				board.setUser_id(rs.getString("userid"));
				board.setTitle(rs.getString("title"));
				board.setAlbum(rs.getString("album"));
				board.setAlbum_art(rs.getString("albumart"));
	...
	public void insertBoard(BoardDTO board) {
		...
		try {
			...
			pstmt.setString(5, board.getAlbum_art());
			pstmt.setString(6, board.getGenre());
			pstmt.setString(7, board.getLyric());
...
//	 선택한 글 상세 내용 가져오기
	...
	public void getImgForMenu(String id) {
		...
		try {
			conn = DBConnection.getConnection();
			String sql = "select userimg from member where id = ?";
